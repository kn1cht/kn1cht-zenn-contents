...
![Image from Gyazo](https://i.gyazo.com/1a235ba7638efdd2e5c92dbbff965f55.gif)
...
:::message
振り返り会によると、CTFdのソース内にFlagがコメントアウトされて記載されていた。
![](/images/open-xint-2025-40548f/sally_source.png =460x)

そういえば確かに意味深なヒントが……
![](/images/open-xint-2025-40548f/sally_hint.png =460x)
:::
...
:::message
振り返り会によると、BLE Beaconに絞り込んでスキャンすると、比較的容易だったしい。

https://play.google.com/store/apps/details?id=com.ideasave.mobilebeaconer&hl=ja&pli=1
:::
...
:::message
振り返り会によると、SatokiさんのスライドのSpeaker NoteにFlagが記載されていたようだ。よく見ると上記のツイートでも確認できる。
:::
