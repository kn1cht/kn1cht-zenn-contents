...
上のようにStartedという表示が出れば完了です。http://localhost:3000 を開きます。
...
「処理は時間がかかります」と記されているとおり、全自動処理にはそれなりに待ち時間があるのでお茶でも飲みながら待ちましょう。筆者の環境（CPU: Ryzen 7 3700X, RAM: 32GB）で試験データ5枚の分析に9分くらいかかりました。
