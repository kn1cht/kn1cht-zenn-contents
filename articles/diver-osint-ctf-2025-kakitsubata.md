...
:::details meow_noisy
まず、チームメンバーのお誘いに快諾いただいた皆様に感謝いたします。  
私の力量からすれば遠く及ばないほど卓越した調査技能を持った方々ばかりでしたので気が引けていたのですが、「このメンツでチームを組んだらラビットホールにハマった時盛り上がるだろうな」というチーム戦の面白さの理論値を目指し、お願いさせていただきました。
その結果、24時間ワイガヤしながら楽しく調査でき、記述式問題にまでたどり着き、実際にレポートを作成することができました。過去に好成績であっても容赦なく振り落とされるシビアな競技の世界で、今回2位という結果を収められたのは、皆様の力量、根性、チーム連携能力のおかげです。ありがとうございました。

そして、Diver運営に最大限の感謝をいたします。  
今回のCTFはこれまでのOSINT CTFの中でトップクラスだったのではないかと思っています。  
まずOSINT問の質が高いことです。検索エンジンで調査すれば解けるという基本方針は守りつつ、変に問題文を曖昧にして難易度を釣り上げたり、guessが必要な要素は排除されており、まともに調査し、丁寧に作り込まれている問題群でした。生成AIの使用がプレイヤーの基本戦術に組み込まれつつある中で、それに負けないレベルで、かつ現実の調査を反映するようにターゲットを見つけるというのは並大抵の労力ではなかったことでしょう。reconカテゴリでは漏洩シナリオを設計した上で、架空のアカウントが長期運用されており「ああ、起こりそうだな」というリアリティをもった問題群に仕上がっていました。これらをわずか1年で用意されたことに、計り知れない力量と熱量を感じます。  
また、競技システムがより調査技能を試験するように反映されている点がプレイヤーとして求めていたものでした。incorrectのペナルティを設けることで総当たりに弱いOSINT問の性質をカバーしていたり、geo問用のプラグインの導入により、作問側もプレイヤー側も変な苦労をかけて座標を整形する作業から開放されました。  
極めつけは現実のターゲットの記述式問題です。レポート問題自体は過去のOSINT CTFにもありましたが、架空のシナリオにとどまっていました。しかし、現実のターゲットというものは今回初めてではないかと思います。当然ながら、これを導入するにあたっては運営側も設計を作り込む必要があり、それにかかる労力は社会人が仕事の傍らでやっていくレベルとしてはハードコアだったはずです。しかしこの要素が加わったことで、優勝争いが完答までのスピードではなく、一番OSINTの本義に近い形でとなったことは、結果はこのようでしたがとても多幸感のある終わり方をできました。チーム6人で共同で調査しレポートを作成した経験は何にも代えがたいものとなりました。レポート問題の導入を決断したことは偉大だと思っています。

さらに、運営の活動自体も誠実に行われている点が、あまり見えない部分ですが、素晴らしいと感じます。[目標](https://github.com/diver-osint-ctf/writeups)に沿った活動を形骸化させることなく、現実の調査を反映した問題作成に全力で取り組まれています。また、[OFUSE](https://ofuse.me/6ccf95fd)による出資を問題の質を向上させることに使っていることにより、「支援すれば、より質の高い問題を楽しめる」という好循環にもなっています。自分たちの活動に対して責任と使命感を持って取り組まれている姿勢が伝わってきます。  
その姿勢の影響もあってか、コミュニティが活性化しているように感じます。Discordの投稿を伺うに、他の界隈から興味で参加されている方々もいれば、本職の分析官まで、国境を越えて参加されている様子が見受けられ、理想的なOSINTコミュニティが形成されつつある印象を受けます。こうした状況は狙ってできることではできないと思っています。

総じてDiver運営は、OSINT CTFの格を確実に引き上げています。現実に適応可能な形でプレイヤーの技術・マインドを育むことに貢献しており、競技という枠を超えた形で活動を展開しているように思えます。昔から「OSINT CTFは”OSINT”とついているがOSINTとは異なる」という指摘を度々受ける(し私もそう思っている1人)のですが、OSINT技能を競うことに専念した結果、ゆくゆくは「OSINT CTFは”CTF”とついているがCTFとは異なる」という認識になっていくのかもしれないなと思いました。Diver運営が過去の何にも当てはまらないを何かを実現することを期待したいです。  
ありがとうございました。

:::

:::details kuzushiki
チームメイトのおかげで今年度も良い成績を収めることができました。

私個人のふりかえりとしては、 力技にあまり頼らずに仮説を立てて攻められたのが良かったと考えています。とある問題ではFirst Bloodも取れました。ただ、全体的な解答スピードはまだまだ伸ばせると感じています。他チームのwriteupでは生成AIを巧みに活用した解法も見られたので、次回は積極的に取り入れたいです。

新しく登場したレポート問題は、正直しんどかったものの良い刺激になりました。昨年度は全完したらそこで終了だったのに対し、今年はコンテスト期間ギリギリまでOSINTに没頭できました。レポート問題は「〇〇について調べてわかったことを書け」というものであり取っ掛かりを掴めずに苦労しましたが、その分「ああでもないこうでもない」とチーム内で議論が盛り上がり楽しかったです。

:::

最後に チーム KAKITSUBATA 一同 DIVER OSINT CTFチームに感謝申し上げます。2025年度も素晴らしいOSINT CTFを開催いただきありがとうございました!🤿
